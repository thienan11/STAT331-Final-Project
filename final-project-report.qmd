...
For our project, we want to explore the relationship between murder rate and happiness score in each country per year
...
TODO:
- Variables selected (define explanatory + response)
- Explain why variables selected
...
(converted to 0 to 100 scale to be in terms of percentage)
...
murder_happiness <- murder_rate_clean |>
